...
This project focuses on analyzing clinical data to identify patterns and correlations associated with Chronic Kidney Disease (CKD). Using Python’s data science stack, the project explores patient demographics, blood chemistry, and physiological indicators to understand how these factors relate to the presence of the disease.
# 🚀 Overview
The dataset contains 400 records with 24 features (including blood pressure, albumin, blood glucose, etc.) and a target class indicating the presence of CKD. This analysis cleans the data, handles missing values, and visualizes key insights.
# 🛠️ Tech Stack
**Language:** Python
